...
Reading order for a new session: [`../STATUS.md`](../STATUS.md) →
[`HANDOFF.md`](HANDOFF.md) → [`DECK_ENGINE_BUILDOUT.md`](DECK_ENGINE_BUILDOUT.md).

- [`HANDOFF.md`](HANDOFF.md) — context, architecture map, decisions (DEC-n), phase plan, pickup guide.
- [`DECK_ENGINE_BUILDOUT.md`](DECK_ENGINE_BUILDOUT.md) — authoritative stage gates and controls (amended 2026-08-20).
- [`DOCUMENTATION_STANDARDS.md`](DOCUMENTATION_STANDARDS.md) — binding documentation rules (AI-compatible docs).
