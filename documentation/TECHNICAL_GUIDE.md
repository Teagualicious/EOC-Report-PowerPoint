...
The current suite contains 244 passing tests in `tests/` at the repo root. It covers pure data/business behavior, document generation that can be tested without Office, Windows DPI sizing helpers, PowerPoint template-preview fallbacks, fill-outcome reporting, and live-preview health tracking.
